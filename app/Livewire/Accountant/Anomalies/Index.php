...
namespace App\Livewire\Accountant\Anomalies;
...
final class Index extends Component
{
    ...
    public function resolve(int $anomalyId, AnomalyDetectorService $service): void
    {
        ...
        $this->dispatch('notify', type: 'success', message: __('accountant.anomalies_resolved_success'));
    ...
    public function ignore(int $anomalyId, AnomalyDetectorService $service): void
    {
        ...
        $this->dispatch('notify', type: 'success', message: __('accountant.anomalies_ignored_success'));
    ...
    {
        return view('livewire.accountant.anomalies.index')
            ->title(__('accountant.anomalies_title'));
    }
}
