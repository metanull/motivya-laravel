...
return [
    ...
    */
    ...
    'image_uploading' => 'Uploading file...',
    'uploading' => 'Uploading...',
    ...
    */
    ...
    'refunds_no_attempts' => 'No refund attempts yet.',
    'refund_audit_status_attempted' => 'Attempted',
    'refund_audit_status_succeeded' => 'Succeeded',
    'refund_audit_status_failed' => 'Failed',
    'refunds_col_eligibility' => 'Eligibility',
    'refunds_col_last_audit' => 'Last Attempt',
    'refunds_badge_eligible' => 'Eligible',
    'refunds_badge_already_refunded' => 'Already Refunded',
    'refunds_badge_missing_payment_intent' => 'Reconciliation Needed',
    'refunds_badge_unpaid' => 'Not Paid',
    'refunds_badge_pending_payment' => 'Pending Payment',
    'refunds_badge_cancelled' => 'Cancelled',
    ...
    */
    ...
    'readiness_check_scheduler' => 'Scheduled task execution',
    ...
    'readiness_check_google_maps_key' => 'Google Maps API key',
    'readiness_check_geocoding_cache' => 'Geocoding cache table',
    'readiness_check_public_storage' => 'Public storage symlink',
    ...
    'readiness_check_stripe_webhook_subscriptions' => 'Stripe webhook event subscriptions',
    'readiness_stripe_webhook_subscriptions_ok' => 'All required Stripe webhook event types are subscribed on the active endpoint.',
    'readiness_stripe_webhook_subscriptions_missing' => 'The Stripe webhook endpoint is missing required event subscriptions: :events. Add these events to the active endpoint in the Stripe Dashboard to ensure payment, refund, and transfer events are received.',
    'readiness_stripe_webhook_subscriptions_no_key' => 'Stripe secret key is not configured. Cannot check webhook subscriptions.',
    'readiness_stripe_webhook_subscriptions_api_error' => 'Could not retrieve Stripe webhook endpoints: :message.',
    ...
    'readiness_scheduler_service_not_configured' => 'No scheduled commands have ever run. The motivya-scheduler.timer service is likely not installed. Run: systemctl status motivya-scheduler.timer',
    'readiness_scheduler_ok' => 'Last run :time.',
    'readiness_scheduler_stale' => 'Last run :time — may be stale.',
    'readiness_scheduler_never_run' => 'Never run. The scheduler service (motivya-scheduler.timer) is not configured in production or has not yet triggered this command. Run: systemctl status motivya-scheduler.timer',
    'readiness_postal_codes_ok' => ':count postal code coordinates loaded.',
    'readiness_postal_codes_missing' => 'No postal code coordinates found. Load the Belgian postal code reference data by running: php artisan geo:load-postal-codes. Then backfill existing sessions: php artisan sessions:backfill-coordinates.',
    'readiness_public_storage_ok' => 'The public/storage symlink is present and reachable.',
    'readiness_public_storage_missing' => 'The public/storage symlink is missing. Each release must create this link via deploy.sh. Re-run the deployment to fix.',
    'readiness_public_storage_broken' => 'The public/storage symlink points to an invalid target (:target). Check the shared storage configuration.',
    'readiness_public_storage_image_missing' => 'The symlink exists but a referenced image file is not found locally (:url). Check shared storage permissions.',
    'readiness_public_storage_no_images' => 'Public storage symlink is present but no activity images have been uploaded yet. Upload at least one image to verify public reachability.',
    'readiness_postal_code_reference_ok' => ':count Belgian postal code coordinates loaded.',
    'readiness_postal_code_reference_missing' => 'No postal code coordinates found. Load reference data: php artisan geo:load-postal-codes. Then backfill sessions: php artisan sessions:backfill-coordinates.',
    'readiness_session_coordinates_ok' => 'All :count sessions have GPS coordinates.',
    'readiness_session_coordinates_all_missing' => ':count session(s) have no GPS coordinates. Run: php artisan sessions:backfill-coordinates after loading postal codes.',
    'readiness_session_coordinates_some_missing' => ':missing of :total session(s) are missing GPS coordinates. Run: php artisan sessions:backfill-coordinates.',
    'readiness_session_coordinates_no_sessions' => 'No sessions created yet. Coordinates will be checked once sessions exist.',
    'readiness_payment_anomalies_ok' => 'No confirmed paid bookings with missing Stripe payment intent.',
    'readiness_payment_anomalies_found' => ':count confirmed booking(s) have amount_paid > 0 but no stripe_payment_intent_id. Run: php artisan payments:reconcile-bookings --dry-run then --repair.',
    'readiness_stripe_connect_ok' => 'All approved coaches with active sessions have completed Stripe onboarding.',
    'readiness_stripe_connect_incomplete' => ':count approved coach(es) with published or confirmed sessions have not completed Stripe Connect onboarding.',
    'readiness_stripe_connect_placeholder' => ':count approved coach(es) with published or confirmed sessions have a placeholder Stripe account ID. Replace with a real Stripe Express account in User Management.',
    'readiness_check_public_storage' => 'Public storage',
    'readiness_check_postal_code_reference' => 'Postal code reference',
    'readiness_check_session_coordinates' => 'Session coordinates',
    'readiness_check_payment_anomalies' => 'Payment anomalies',
    ...
    'readiness_google_maps_key_ok' => 'Google Maps API key is configured.',
    'readiness_google_maps_key_missing' => 'GOOGLE_MAPS_API_KEY is not set. Google geocoding fallback is disabled. Map display (MapLibre/OpenFreeMap) still works.',
    'readiness_google_maps_key_format' => 'GOOGLE_MAPS_API_KEY does not match the expected AIza... format.',
    'readiness_geocoding_cache_ok' => 'Geocoding cache table is available.',
    'readiness_geocoding_cache_missing' => 'Geocoding cache table is missing. Run php artisan migrate.',
    'readiness_check_map_provider' => 'Map provider',
    'readiness_map_provider_google_ok' => 'Google Maps Platform — API key configured and reachable.',
    'readiness_map_provider_google_key_missing' => 'Google Maps Platform selected but GOOGLE_MAPS_API_KEY is not set.',
    'readiness_map_provider_google_key_format' => 'GOOGLE_MAPS_API_KEY does not match the expected AIza... format.',
    'readiness_map_provider_free_ok' => 'Free stack (OpenFreeMap + Nominatim) — configured and reachable.',
    'readiness_map_provider_free_tile_missing' => 'Free stack: MAPS_TILE_STYLE_URL is not configured.',
    'readiness_map_provider_free_geocoding_missing' => 'Free stack: geocoding URL is not configured.',
    'readiness_map_provider_unreachable' => 'Map provider geocoding endpoint is not reachable: :message',
    'readiness_check_address_precision' => 'Address precision',
    'readiness_address_precision_ok' => 'All :total addresses (sessions + profiles) are exact validated addresses with GPS coordinates.',
    ...
    'readiness_action_anomalies' => 'View anomalies',
    'readiness_action_coach_approval' => 'Coach approval',
    'readiness_operations_heading' => 'Operational Repair Tools',
    'readiness_operations_subtitle' => 'Read-only commands to run on the server to fix detected issues. None of these commands are executed automatically from this interface.',
    'readiness_operations_load_postal_codes' => 'Load Belgian postal codes',
    'readiness_operations_backfill_coordinates' => 'Backfill session coordinates',
    'readiness_operations_reconcile_dry_run' => 'Payment audit (dry-run, no changes)',
    'readiness_operations_reconcile_repair' => 'Payment repair (queries Stripe, writes)',
    'readiness_operations_health_snapshot' => 'Health snapshot (read-only)',
    'readiness_operations_scheduler_status' => 'Scheduler status',
