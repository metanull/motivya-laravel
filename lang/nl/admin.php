...
return [
    ...
    */
    ...
    'readiness_check_stripe_webhook_subscriptions' => 'Stripe webhook-gebeurtenisabonnementen',
    'readiness_stripe_webhook_subscriptions_ok' => 'Alle vereiste Stripe webhook-gebeurtenistypes zijn geabonneerd op het actieve eindpunt.',
    'readiness_stripe_webhook_subscriptions_missing' => 'Het Stripe webhook-eindpunt mist vereiste gebeurtenisabonnementen: :events. Voeg deze gebeurtenissen toe aan het actieve eindpunt in het Stripe Dashboard.',
    'readiness_stripe_webhook_subscriptions_no_key' => 'Stripe geheime sleutel is niet geconfigureerd. Kan webhook-abonnementen niet controleren.',
    'readiness_stripe_webhook_subscriptions_api_error' => 'Kon Stripe webhook-eindpunten niet ophalen: :message.',
    ...
    'readiness_check_map_provider' => 'Kaartprovider',
    'readiness_map_provider_google_ok' => 'Google Maps Platform — API-sleutel geconfigureerd en bereikbaar.',
    'readiness_map_provider_google_key_missing' => 'Google Maps Platform geselecteerd maar GOOGLE_MAPS_API_KEY is niet ingesteld.',
    'readiness_map_provider_google_key_format' => 'GOOGLE_MAPS_API_KEY komt niet overeen met het verwachte AIza...-formaat.',
    'readiness_map_provider_free_ok' => 'Gratis stack (OpenFreeMap + Nominatim) — geconfigureerd en bereikbaar.',
    'readiness_map_provider_free_tile_missing' => 'Gratis stack: MAPS_TILE_STYLE_URL is niet geconfigureerd.',
    'readiness_map_provider_free_geocoding_missing' => 'Gratis stack: geocoderings-URL is niet geconfigureerd.',
    'readiness_map_provider_unreachable' => 'Geocoderings-eindpunt van kaartprovider is niet bereikbaar: :message',
    'readiness_check_address_precision' => 'Adresprecisie',
    'readiness_address_precision_ok' => 'Alle :total adressen (sessies + profielen) zijn exacte gevalideerde adressen met GPS-coördinaten.',
