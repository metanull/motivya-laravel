...
return [
    ...
    'anomaly_paid_cancelled_without_refund' => 'Geen terugbetaling',
    ...
    /*
    |--------------------------------------------------------------------------
    | Accountant — Financieel auditlogboek-viewer
    |--------------------------------------------------------------------------
    */

    'audit_events_title' => 'Financieel auditlogboek',
    'audit_events_heading' => 'Financieel auditgebeurtenissenlogboek',
    'audit_events_subtitle' => 'Alleen-lezen logboek van financiële en betalingsgerelateerde auditgebeurtenissen.',
    ...
    'audit_events_filter_model_type_placeholder' => 'bijv. Invoice…',
