...
return [
    ...
    */
    ...
    'refunds_no_attempts' => 'Aucune tentative de remboursement.',
    'refund_audit_status_attempted' => 'Tentative',
    'refund_audit_status_succeeded' => 'Réussi',
    'refund_audit_status_failed' => 'Échoué',
    'refunds_col_eligibility' => 'Éligibilité',
    'refunds_col_last_audit' => 'Dernière tentative',
    'refunds_badge_eligible' => 'Éligible',
    'refunds_badge_already_refunded' => 'Déjà remboursé',
    'refunds_badge_missing_payment_intent' => 'Réconciliation requise',
    'refunds_badge_unpaid' => 'Non payé',
    'refunds_badge_pending_payment' => 'Paiement en attente',
    'refunds_badge_cancelled' => 'Annulé',
    ...
    */
    ...
    'readiness_check_scheduler' => 'Exécution des tâches planifiées',
    ...
    'readiness_check_stripe_webhook_subscriptions' => 'Abonnements aux événements Stripe webhook',
    'readiness_stripe_webhook_subscriptions_ok' => 'Tous les types d\'événements Stripe webhook requis sont abonnés sur le point de terminaison actif.',
    'readiness_stripe_webhook_subscriptions_missing' => 'Le point de terminaison Stripe webhook manque des abonnements aux événements requis : :events. Ajoutez ces événements au point de terminaison actif dans le tableau de bord Stripe.',
    'readiness_stripe_webhook_subscriptions_no_key' => 'La clé secrète Stripe n\'est pas configurée. Impossible de vérifier les abonnements webhook.',
    'readiness_stripe_webhook_subscriptions_api_error' => 'Impossible de récupérer les points de terminaison Stripe webhook : :message.',
    ...
    'readiness_scheduler_service_not_configured' => 'Aucune tâche planifiée n\'a jamais été exécutée. Le service motivya-scheduler.timer n\'est probablement pas installé sur le serveur. Exécutez : systemctl status motivya-scheduler.timer',
    'readiness_scheduler_ok' => 'Dernière exécution :time.',
    'readiness_scheduler_stale' => 'Dernière exécution :time — peut être obsolète.',
    'readiness_scheduler_never_run' => 'Jamais exécuté. Le planificateur de tâches (motivya-scheduler.timer) n\'est pas configuré en production ou n\'a pas encore déclenché cette commande. Exécutez : systemctl status motivya-scheduler.timer',
    'readiness_postal_codes_ok' => ':count coordonnées de codes postaux chargées.',
    'readiness_postal_codes_missing' => 'Aucune coordonnée de code postal trouvée. Chargez les données de référence des codes postaux belges en exécutant : php artisan geo:load-postal-codes. Ensuite mettez à jour les sessions existantes avec : php artisan sessions:backfill-coordinates.',
    'readiness_public_storage_ok' => 'Le lien symbolique public/storage est présent et accessible.',
    'readiness_public_storage_missing' => 'Le lien symbolique public/storage est absent. Chaque version doit créer ce lien via deploy.sh. Exécutez le déploiement pour corriger.',
    'readiness_public_storage_broken' => 'Le lien symbolique public/storage pointe vers une cible invalide (:target). Vérifiez la configuration du stockage partagé.',
    'readiness_public_storage_image_missing' => 'Le lien symbolique existe mais un fichier image référencé est introuvable localement (:url). Vérifiez les permissions du stockage partagé.',
    'readiness_public_storage_no_images' => 'Le lien symbolique du stockage public est présent mais aucune image d\'activité n\'a encore été téléchargée. Téléchargez au moins une image pour vérifier l\'accessibilité publique.',
    'readiness_postal_code_reference_ok' => ':count coordonnées de codes postaux belges chargées.',
    'readiness_postal_code_reference_missing' => 'Aucune coordonnée de code postal trouvée. Chargez les données de référence avec : php artisan geo:load-postal-codes. Ensuite lancez la mise à jour des sessions : php artisan sessions:backfill-coordinates.',
    'readiness_session_coordinates_ok' => 'Toutes les :count sessions ont des coordonnées GPS.',
    'readiness_session_coordinates_all_missing' => ':count session(s) n\'ont aucune coordonnée GPS. Lancez : php artisan sessions:backfill-coordinates après avoir chargé les codes postaux.',
    'readiness_session_coordinates_some_missing' => ':missing session(s) sur :total sont sans coordonnées GPS. Lancez : php artisan sessions:backfill-coordinates.',
    'readiness_session_coordinates_no_sessions' => 'Aucune session créée. Les coordonnées seront vérifiées lorsque des sessions existeront.',
    'readiness_payment_anomalies_ok' => 'Aucun paiement confirmé sans identifiant d\'intention de paiement Stripe.',
    'readiness_payment_anomalies_found' => ':count réservation(s) confirmée(s) avec montant payé mais sans stripe_payment_intent_id. Lancez : php artisan payments:reconcile-bookings --dry-run puis --repair pour corriger.',
    'readiness_stripe_connect_ok' => 'Tous les coachs approuvés avec des sessions actives ont terminé l\'intégration Stripe.',
    'readiness_stripe_connect_incomplete' => ':count coach(s) approuvé(s) avec des sessions publiées ou confirmées n\'ont pas finalisé leur intégration Stripe Connect.',
    'readiness_stripe_connect_placeholder' => ':count coach(s) approuvé(s) avec des sessions publiées ou confirmées ont un identifiant de compte Stripe factice. Remplacez-le par un vrai compte Stripe Express dans la gestion des utilisateurs.',
    'readiness_check_public_storage' => 'Stockage public',
    'readiness_check_postal_code_reference' => 'Référentiel codes postaux',
    'readiness_check_session_coordinates' => 'Coordonnées des sessions',
    'readiness_check_payment_anomalies' => 'Anomalies de paiement',
    'readiness_check_stripe_connect' => 'Stripe Connect des coachs',
    ...
    'readiness_check_map_provider' => 'Fournisseur de cartes',
    'readiness_map_provider_google_ok' => 'Google Maps Platform — clé API configurée et accessible.',
    'readiness_map_provider_google_key_missing' => 'Google Maps Platform sélectionné mais GOOGLE_MAPS_API_KEY n\'est pas défini.',
    'readiness_map_provider_google_key_format' => 'GOOGLE_MAPS_API_KEY ne correspond pas au format attendu AIza...',
    'readiness_map_provider_free_ok' => 'Stack libre (OpenFreeMap + Nominatim) — configuré et accessible.',
    'readiness_map_provider_free_tile_missing' => 'Stack libre : MAPS_TILE_STYLE_URL n\'est pas configuré.',
    'readiness_map_provider_free_geocoding_missing' => 'Stack libre : l\'URL de géocodage n\'est pas configurée.',
    'readiness_map_provider_unreachable' => 'Le point de terminaison de géocodage du fournisseur de cartes n\'est pas accessible : :message',
    'readiness_check_address_precision' => 'Précision des adresses',
    'readiness_address_precision_ok' => 'Toutes les :total adresses (sessions + profils) sont des adresses exactes validées avec coordonnées GPS.',
    ...
    'readiness_action_anomalies' => 'Voir les anomalies',
    'readiness_action_coach_approval' => 'Approbation des coachs',
    'readiness_operations_heading' => 'Outils de réparation opérationnelle',
    'readiness_operations_subtitle' => 'Commandes en lecture seule à exécuter sur le serveur pour corriger les problèmes détectés. Aucune de ces commandes n\'est exécutée automatiquement depuis cette interface.',
    'readiness_operations_load_postal_codes' => 'Charger les codes postaux belges',
    'readiness_operations_backfill_coordinates' => 'Mettre à jour les coordonnées des sessions',
    'readiness_operations_reconcile_dry_run' => 'Audit des paiements (sans modification)',
    'readiness_operations_reconcile_repair' => 'Réparation des paiements (avec modification Stripe)',
    'readiness_operations_health_snapshot' => 'Instantané d\'état de santé (lecture seule)',
    'readiness_operations_scheduler_status' => 'Statut du planificateur',
